...
@section('content')
    <div class="flex items-center justify-center h-full container mx-auto">
        ...
        <form class="w-full sm:w-1/2 lg:1/3 flex items-center justify-center flex-col border-t-4 border-orange rounded shadow mx-1" method="POST" action="{{ route('register') }}">
