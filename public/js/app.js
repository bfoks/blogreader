...
Vue.component('blog-create-form', __webpack_require__(7));
...
Component.options.__file = "resources/assets/js/components/BlogCreateForm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-31bfdbce", Component.options)
  } else {
    hotAPI.reload("data-v-31bfdbce", Component.options)
  }
